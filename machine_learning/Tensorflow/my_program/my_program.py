...
cross_entropy = cal_cross_entropy(y_, y_conv)
#cross_entropy是真实y和预测y之间的偏差

#梯度下降法
train_step = adam_optimizer(cross_entropy)

accuracy = cal_accuracy(y_conv, y_)

mnist = input_data.read_data_sets('MNIST_data', one_hot=True)

#看来这个sess是个很重要的东西，应该是初始化tf的一个进程
